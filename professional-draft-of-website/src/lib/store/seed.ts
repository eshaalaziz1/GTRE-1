...
export const SEED: GtreState = {
  ...
  events: [
    ...
    { id: "ap-4", track: "Analyst Program", order: 3, type: "Event", title: "Recruitment Event", date: "2026-09-28", time: "6:00 PM", location: "Caddell", checkInCode: "RECRUIT", checkInOpen: false },
    ...
    { id: "ap-10", track: "Analyst Program", order: 9, type: "Case Study", title: "Case Study Example / Check In", date: "2026-11-09", time: "6:00 PM", location: "Caddell", checkInCode: "CHECKIN", checkInOpen: true },
    { id: "ap-11", track: "Analyst Program", order: 10, type: "Event", title: "Peachtree Group", date: "2026-11-16", time: "6:00 PM", location: "Caddell", checkInCode: "PEACH", checkInOpen: false },
    { id: "ap-12", track: "Analyst Program", order: 11, type: "Case Study", title: "Case Study Work Period", date: "2026-11-23", time: "6:00 PM", location: "Caddell" },
    { id: "ap-13", track: "Analyst Program", order: 12, type: "Case Study", title: "Presentations Day 1", date: "2026-11-30", time: "6:00 PM", location: "Caddell", checkInCode: "PRES1", checkInOpen: false },
